...
class NetworkManager {
  ...
  // new method: Async/Await (you don't have to deal with weak self, update the ui on the main thread, that's all handled.
...
//  }
  ...
  // not using throws, 'cause we don't care about the errors.do i have an image or is it nil?
